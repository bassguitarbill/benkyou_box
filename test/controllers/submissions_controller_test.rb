...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference("Submission.count") do
      post submissions_url, params: { submission: { prompt: @submission.prompt, response: @submission.response, user_id: @submission.user_id } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { prompt: @submission.prompt, response: @submission.response, user_id: @submission.user_id } }
